define(['jquery', 'knockout', 'd3', 'text!./network-simple.html', 'mapping'], function($, ko, d3, templateMarkup, map) {

    function NetworkSimple(params, componentInfo) {
        var self = this;
        self.element = componentInfo.element;
        self.firstRender = ko.observable(true)
        self.message = ko.observable('this is a test')

        self.changeMessage = function() {
            self.message('this is a new message')
        }
    ...
    NetworkSimple.prototype.dispose = function() {};
